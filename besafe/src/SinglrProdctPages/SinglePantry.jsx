        ...
        <div className={styles.container}>
          ...
          <>
            <div className={styles.product_img}>
              {/************************** Showing big image  ************/}
              <img src={pantry?.img[0].subImage} alt="Product" />
              <br></br>

              {/************** Showing all buttom small image *************/}
              <div className={styles.small_img}>
                {pantry?.img.slice(1).map((img) => (
                  <>
                    <Image
                      // onClick={onOpen}
                  ...
                  <Tabs variant="enclosed" color="gray">
                    ...
                    <TabPanels color="black" border="1px solid #e8edf3">
                      <TabPanel>
                        ...
                        <li>Finishing salt for savory and sweet dishes alike</li>
                        <li>4 oz.</li>
                        <li>Hand-harvested and hand-sorted off the Oregon Coast</li>
                        <li>Produced by Jacobsen Salt Co</li>
                      </TabPanel>
                      <TabPanel>
                        <li >
                      ...
                      <TabPanel>
                        <p className={styles.tabs}>We accept returns (non-consumable products only), and will provide a full refund for the price of the item. Items must be shipped back within 30 days of receipt in their original packaging and condition. To make a return, please email market@blueapron.com and we will provide you with the return address as well as any shipping instructions that may apply. Consumable products are non-returnable but are protected by our <Link className={styles.guarantee}>Freshness Guarantee</Link></p>
                      </TabPanel>
                    </TabPanels>
                  </Tabs>
                </div>
